...
import { createStripeInvoiceForSale } from '../services/stripe/stripeInvoiceFacade.js';
...
// Pré-React E2 — `planGiftCardUsage`/`finalizeGiftCardUsage` (+ helpers carte cadeau) extraits
// vers services/checkout/checkoutGiftCardService.js (déplacement structurel, comportement
// identique). Importés ci-dessus.
